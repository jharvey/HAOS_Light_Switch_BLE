## 1. Brief Overview
This is a baby step for making a BLE switch for HAOS. This is intended to show how to use the SWO of the programming interface allowing debug messages to be broadast. It's a hello world baby step applicaion. 
